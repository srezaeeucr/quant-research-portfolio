#!/usr/bin/env python3
"""
All-Day Extended Grid — covers symbols NOT in the quick grid.
Fills the gap: XLE (surprise winner), SPY, MSFT, GOOGL with all-day windows.

~36,864 combos, ~12 hours on Mac Mini.
"""
import os
...
def main():
    ...
    print(f"\n  All-Day Extended Grid")
    print(f"  Strategies : {GRID['strategies']}")
    print(f"  Symbols    : {GRID['symbols']}")
    print(f"  Windows    : {GRID['entry_window_minutes']} min after 9:45")
